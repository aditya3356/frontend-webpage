    ...
    <div className="pl-[57px] pr-[175px] pt-[47px] absolute mt-[60px] font-bold flex">
      <div>
        ...
        <div className="grid grid-cols-2 auto-rows-auto gap-x-[57px] gap-y-10">
          {orgs.map((org, idx) => (
            <div className="w-[415px] flex items-center">
              ...
              {org.tracking ? (
                <div className="w-[74px] h-[30px] ml-[134px] text-xs text-[#1AAB2B] flex justify-center items-center box-border border-[1px] border-solid border-[#1AAB2B] rounded-sm">
                  Tracking
                </div>
              ) : (
                <div
                  className="w-[53px] h-[30px] ml-[134px] text-xs text-[#FF6059] flex justify-center items-center box-border border-[1px] border-solid border-[#FF6059] rounded-sm cursor-pointer"
